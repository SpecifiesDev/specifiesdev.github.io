    ...
    function pushMedium() {
    	mediumPlayers.push(medium({x: returnRandom(0, canvas.width - 11), y: returnRandom(0, canvas.height -11)}));
    }
    function pushHard() {
        hardPlayers.push(hard({x: returnRandom(0, canvas.width -11), y: returnRandom(0, canvas.height - 11)}));
    }
    function pushInsane() {
        insanePlayers.push(insane({x: returnRandom(0, canvas.width -11), y: returnRandom(0, canvas.height - 11)}));
    }
